...
A spam-filtered, open-data registry of [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) (`dsh`) plugins, bundles, and skills — 565 entries across 17 functional areas, every one stating the dsh version it was last verified against.
...
541 Cordis plugins activated through patch rows in a bundle or profile, grouped by what they do. Data updated 2026-08-14.
...
| dsh-workbench-dpf555 | 3 | [Dpf555/dsh-workbench](https://github.com/Dpf555/dsh-workbench) | VS Code-style three-column layout for the DSH web GUI: docked Explorer file tree + Monaco code editor that replaces the chat column when a file is opened | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-tool-calculator | 5 | [omdsh-dev/dsh-tool-calculator](https://github.com/omdsh-dev/dsh-tool-calculator) · [npm](https://www.npmjs.com/package/@deepseek-ai/dsh-tool-calculator) | DSH calculator tool | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-tool-csv | 3 | [omdsh-dev/dsh-tool-csv](https://github.com/omdsh-dev/dsh-tool-csv) · [npm](https://www.npmjs.com/package/@deepseek-ai/dsh-tool-csv) | DSH CSV data tool: parse/query/stats over RFC 4180 CSV text, zero-dependency state-machine parser | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-sandbox-microsandbox | 2 | [omdsh-dev/sandbox-micro](https://github.com/omdsh-dev/sandbox-micro) · [npm](https://www.npmjs.com/package/@deepseek-ai/dsh-sandbox-microsandbox) | Fail-closed microsandbox microVM provider and model-facing guest tools | 0.1.0-rc.6 (2026-08-14) |
| dsh-sandbox-nono | 2 | [omdsh-dev/sandbox-nono](https://github.com/omdsh-dev/sandbox-nono) · [npm](https://www.npmjs.com/package/@deepseek-ai/dsh-sandbox-nono) | nono (Landlock/Seatbelt) backend for the DeepSeek Harness sandbox seam with a vendored fail-closed executor | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-tool-diff | 2 | [omdsh-dev/dsh-tool-diff](https://github.com/omdsh-dev/dsh-tool-diff) · [npm](https://www.npmjs.com/package/@deepseek-ai/dsh-tool-diff) | DSH diff tool: structured comparison of text/JSON/CSV/Markdown plus unified diff generation and in-memory patch validation. Zero-dependency, read-only. | 0.1.0-rc.6 (2026-08-14) |
| dsh-tool-encoding | 2 | [omdsh-dev/dsh-tool-encoding](https://github.com/omdsh-dev/dsh-tool-encoding) · [npm](https://www.npmjs.com/package/@deepseek-ai/dsh-tool-encoding) | DSH encoding tool plugin | 0.1.0-rc.6 (2026-08-14) |
| dsh-tool-json | 2 | [omdsh-dev/dsh-tool-json](https://github.com/omdsh-dev/dsh-tool-json) · [npm](https://www.npmjs.com/package/@deepseek-ai/dsh-tool-json) | DSH JSON query tool | 0.1.0-rc.6 (2026-08-14) |
| dsh-tool-markdown | 2 | [omdsh-dev/dsh-tool-markdown](https://github.com/omdsh-dev/dsh-tool-markdown) · [npm](https://www.npmjs.com/package/@deepseek-ai/dsh-tool-markdown) | DSH Markdown tool: HTML-to-Markdown conversion, whitelisted Markdown-to-HTML, GFM table normalization, TOC generation. Zero-dependency lightweight parsers. | 0.1.0-rc.6 (2026-08-14) |
| dsh-tool-regex | 2 | [omdsh-dev/dsh-tool-regex](https://github.com/omdsh-dev/dsh-tool-regex) · [npm](https://www.npmjs.com/package/@deepseek-ai/dsh-tool-regex) | DSH regex tool: test/find/replace over text plus static pattern explanation, zero-dependency with ReDoS guards | 0.1.0-rc.6 (2026-08-14) |
| dsh-tool-schema | 2 | [omdsh-dev/dsh-tool-schema](https://github.com/omdsh-dev/dsh-tool-schema) · [npm](https://www.npmjs.com/package/@deepseek-ai/dsh-tool-schema) | DSH JSON Schema validation tool: validate, failure paths, static explain, default-only normalize; zero-network, zero-dynamic-code with resource limits and a pattern ReDoS worker budget | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-sandbox-mxc | 1 | [omdsh-dev/sandbox-mxc](https://github.com/omdsh-dev/sandbox-mxc) · [npm](https://www.npmjs.com/package/@deepseek-ai/dsh-sandbox-mxc) | Microsoft eXecution Containers (MXC) backend for the DeepSeek Harness sandbox seam | 0.1.0-rc.6 (2026-08-14) |
| dsh-system-proxy | 1 | [khiqwq/dsh-system-proxy](https://github.com/khiqwq/dsh-system-proxy) · [npm](https://www.npmjs.com/package/dsh-system-proxy) | DSH host plugin — smart outbound HTTP(S) routing: named proxies (http/https/socks4/4a/5/5h), per-host/provider/plugin rules, direct-first fallback with health memory (global fetch + node http/https). | 0.1.0-rc.6 (2026-08-14) |
...
| godot-bridge | 1 | [Smalldy/godot-bridge](https://github.com/Smalldy/godot-bridge) · [npm](https://www.npmjs.com/package/godot-bridge) | DSH (DeepSeek Harness) plugin: launch and drive a running Godot 4.x game through its in-game TCP interaction server — replaces the godot-mcp MCP server with native agent tools. | 0.1.0-rc.6 (2026-08-14) |
| dsh-any-attachment | 0 | [Zenjibad/dsh-any-attachment](https://github.com/Zenjibad/dsh-any-attachment) · [npm](https://www.npmjs.com/package/dsh-any-attachment) | dsh bundle: attach any file type in dsh web — text-likes inline, binaries as workspace path references, rasters via the built-in pipeline | 0.1.0-rc.6 (2026-08-14) |
| dsh-anydrop | 0 | [babutiger/dsh-anydrop](https://github.com/babutiger/dsh-anydrop) · [npm](https://www.npmjs.com/package/dsh-anydrop) | Drop-anything plugin for DeepSeek Harness: immutable per-message attachment IDs, streaming binary uploads, idempotent batch synchronization, restart-safe manifests, chunked large-file reads, and. | 0.1.0-rc.6 (2026-08-14) |
| dsh-chem-render | 0 | [EQmarks/dsh-chem-render](https://github.com/EQmarks/dsh-chem-render) · [npm](https://www.npmjs.com/package/dsh-chem-render) | Deterministic chemical-structure rendering for DeepSeek Harness: one chem_render tool turns a SMILES string into SVG, PNG, standalone HTML, Markdown and LaTeX (includegraphics + optional native. | 0.1.0-rc.6 (2026-08-14) |
| dsh-cohub-board | 0 | [kjx-talesofai/dsh-cohub-board](https://github.com/kjx-talesofai/dsh-cohub-board) · [npm](https://www.npmjs.com/package/dsh-cohub-board) | Cohub Board agent tools (draw/read/clear/export) for DeepSeek Harness | 0.1.0-rc.6 (2026-08-14) |
| dsh-computer-use-geohotstan | 0 | [geohotstan/dsh-computer-use](https://github.com/geohotstan/dsh-computer-use) · [npm](https://www.npmjs.com/package/dsh-computer-use) | Desktop computer use for DeepSeek Harness (DSH): macOS app listing, accessibility-tree window capture, screenshots, and synthesized input — the seam, the local Swift-daemon provider, the. | 0.1.0-rc.6 (2026-08-14) |
| dsh-content-studio | 0 | [ZRui-C/dsh-content-studio](https://github.com/ZRui-C/dsh-content-studio) · [npm](https://www.npmjs.com/package/dsh-content-studio) | DSH bundle plugin: 内容创作与多平台分发 —— 桌面截屏/录屏、Markdown→小红书图文卡片（5 配色 × 4 版式、照片插图、背景图）、dev.to 官方 API 发布、发布前人工审阅（草稿落盘），并挂载 Playwright 与小红书 MCP。 | 0.1.0-rc.6 (2026-08-14) |
| dsh-web-search-tavily-myflv | 0 | [myflv/dsh-web-search-tavily](https://github.com/myflv/dsh-web-search-tavily) | Tavily-backed search provider for the DeepSeek Harness web capability seam (ctx.web) | 0.1.0-rc.6 (2026-08-14) |
| dsh-workspace-file-upload | 0 | [shililinghu/dsh-file-upload-deepseek-harness-plug-in](https://github.com/shililinghu/dsh-file-upload-deepseek-harness-plug-in) · [npm](https://www.npmjs.com/package/@agent-hub/dsh-workspace-file-upload) | Generic file upload compatibility layer for DeepSeek Harness web | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-prism | 2 | [YOGEMOW/DeepSeek_Prism](https://github.com/YOGEMOW/DeepSeek_Prism/tree/HEAD/dsh-plugin) · [npm](https://www.npmjs.com/package/@yogemow/dsh-prism) | DeepSeek Prism 仓库根：Codex Skill 与 DeepSeek Harness 插件双包发布 | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-agent-rp | 102 | [hewzhew/dsh-agent-rp](https://github.com/hewzhew/dsh-agent-rp) · [npm](https://www.npmjs.com/package/@dsh-external/dsh-agent-rp) | SillyTavern migration and next-generation Agent RP for DSH | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-agent-preset-recommender | 0 | [LeemanCheung/dsh-agent-preset-recommender](https://github.com/LeemanCheung/dsh-agent-preset-recommender) · [npm](https://www.npmjs.com/package/dsh-agent-preset-recommender) | Privacy-safe local activity scanner and agent preset recommender for DeepSeek Harness | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-resume | 0 | [xiaohj233/dsh-resume](https://github.com/xiaohj233/dsh-resume) · [npm](https://www.npmjs.com/package/dsh-resume) | Resume interrupted DSH turns from an empty submit and restore sessions or subagents that were running at process shutdown. | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-openai-oauth | 2 | [DGPisces/dsh-openai-oauth](https://github.com/DGPisces/dsh-openai-oauth) · [npm](https://www.npmjs.com/package/dsh-openai-oauth) | DeepSeek Harness LLM provider for Codex models using managed ChatGPT OAuth | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-gpt-file-discipline | 0 | [youxi-huang/dsh-gpt-file-discipline](https://github.com/youxi-huang/dsh-gpt-file-discipline) · [npm](https://www.npmjs.com/package/dsh-gpt-file-discipline) | A configurable DeepSeek Harness host plugin that adds file-discipline guidance to selected model steps. | 0.1.0-rc.6 (2026-08-14) |
| dsh-llm-newapi | 0 | [wenzetan/dsh-llm-newapi](https://github.com/wenzetan/dsh-llm-newapi) · [npm](https://www.npmjs.com/package/dsh-llm-newapi) | NewAPI (OpenAI-compatible gateway) chat-completions adapter for the DeepSeek Harness LLM seam. Provider route id 'newapi', display name 'NewAPI'. Dual-face: host half registers the LLM adapter and. | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-channel-feishu | 3 | [ZinkLu/dsh-channel](https://github.com/ZinkLu/dsh-channel/tree/HEAD/packages/channel-feishu) · [npm](https://www.npmjs.com/package/dsh-channel-feishu) | A DeepSeek Harness channel plugin written entirely by DeepSeek Harness itself. | 0.1.0-rc.6 (2026-08-14) |
| dsh-channel-telegram | 3 | [ZinkLu/dsh-channel](https://github.com/ZinkLu/dsh-channel/tree/HEAD/packages/channel-telegram) · [npm](https://www.npmjs.com/package/dsh-channel-telegram) | A DeepSeek Harness channel plugin written entirely by DeepSeek Harness itself. | 0.1.0-rc.6 (2026-08-14) |
| dsh-channel-wechat | 3 | [ZinkLu/dsh-channel](https://github.com/ZinkLu/dsh-channel/tree/HEAD/packages/channel-wechat) · [npm](https://www.npmjs.com/package/dsh-channel-wechat) | A DeepSeek Harness channel plugin written entirely by DeepSeek Harness itself. | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-mobile-fenghuolinshan | 0 | [FengHuoLinShan/dsh-mobile](https://github.com/FengHuoLinShan/dsh-mobile) · [npm](https://www.npmjs.com/package/dsh-mobile) | DSH 远程访问插件(out-of-tree bundle): 局域网/Tailscale 访问 + PIN 设备配对 + 移动端 UI | 0.1.0-rc.6 (2026-08-14) |
| dsh-weixin-skylar | 0 | [skylar-fei/dsh-wechat-maid](https://github.com/skylar-fei/dsh-wechat-maid/tree/HEAD/packages/dsh-weixin) | DSH Web 插件合集：微信机器人（连接 + 主动消息/定时推送）+ 深蓝女仆桌宠，两个插件共享构建预设的单仓库。 | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-token-usage-leemancheung | 2 | [LeemanCheung/dsh-token-usage](https://github.com/LeemanCheung/dsh-token-usage) · [npm](https://www.npmjs.com/package/dsh-token-usage) | Persistent token usage records and dashboard for DeepSeek Harness | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-balance-deepforce | 0 | [deepforce/dsh-balance](https://github.com/deepforce/dsh-balance) · [npm](https://www.npmjs.com/package/@deepforce/dsh-balance) | Human-facing /balance slash command that queries the DeepSeek account balance | 0.1.0-rc.6 (2026-08-14) |
| dsh-balance-lemcae | 0 | [LemCAE/dsh-balance](https://github.com/LemCAE/dsh-balance) · [npm](https://www.npmjs.com/package/@lemcae/dsh-balance) | DeepSeek Open Platform balance and session consumption readout (host + web client) | 0.1.0-rc.6 (2026-08-14) |
| dsh-heatmap | 0 | [283Gawin/dsh-heatmap](https://github.com/283Gawin/dsh-heatmap) · [npm](https://www.npmjs.com/package/@linxin666/dsh-client-ui-activity-heatmap) | Activity heatmap for the dsh web GUI sidebar: a persistent GitHub-style year grid switching between daily commits / token usage / estimated spend, plus a today line with all-session token totals,. | 0.1.0-rc.6 (2026-08-14) |
| dsh-opencodego-usage | 0 | [BeiZi6/dsh-opencodego-usage](https://github.com/BeiZi6/dsh-opencodego-usage) · [npm](https://www.npmjs.com/package/dsh-opencodego-usage) | OpenCodeGo 用量 v0.1（作者：Xu Yuanshan）：输入框右下角呼吸灯显示剩余额度，点击展开液态玻璃面板——三窗口进度条（5小时/7天/30天）+ 重置时间，Key 自动读取 DSH 凭据（opencode-go 提供商）。 | 0.1.0-rc.6 (2026-08-14) |
| dsh-provider-usage | 0 | [Lwc-LiuWenCheng/dsh-provider-usage](https://github.com/Lwc-LiuWenCheng/dsh-provider-usage) · [npm](https://www.npmjs.com/package/dsh-provider-usage) | DSH web plugin: a bottom-right bubble showing the live usage/quota of every configured LLM model provider (OpenCodeGo, OpenRouter, OpenAI, DeepSeek…), with a configurable update policy (on user. | 0.1.0-rc.6 (2026-08-14) |
| dsh-quota-panel-wenzetan | 0 | [wenzetan/dsh-quota-panel](https://github.com/wenzetan/dsh-quota-panel) · [npm](https://www.npmjs.com/package/dsh-quota-panel) | Provider quota/balance widget for the dsh web surface: collapsed glanceable capsule expanding into a Harness-native card with a settings panel (provider visibility / refresh interval / warn. | 0.1.0-rc.6 (2026-08-14) |
| dsh-token-cost | 0 | [le-soleil-se-couche/dsh-token-cost](https://github.com/le-soleil-se-couche/dsh-token-cost) | DSH web GUI plugin: token usage (input/output), cache hit/miss and cost statistics per conversation and in aggregate, with auto-switching DeepSeek pricing schemes | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-llm-inspector | 0 | [cdxiaodong/dsh-llm-inspector](https://github.com/cdxiaodong/dsh-llm-inspector) · [npm](https://www.npmjs.com/package/dsh-llm-inspector) | 统一 LLM 请求/响应检查器：调 reasoning effort、外部思考(think)导出、流量与包分析 —— DeepSeek Harness 插件 | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-skills-mcp-manager | 1 | [zebbkira/dsh-skills-mcp-manager](https://github.com/zebbkira/dsh-skills-mcp-manager) · [npm](https://www.npmjs.com/package/@zebbkira/dsh-skills-mcp-manager) | Skills & MCP manager for the dsh web GUI: browse/enable/import/delete skills across project and user roots, and manage MCP servers with a REAL connection through @deepseek-ai/dsh-mcp-client (enabled. | 0.1.0-rc.6 (2026-08-14) |
| dsh-mcp-admin | 0 | [kairoz9/dsh-mcp-admin](https://github.com/kairoz9/dsh-mcp-admin) · [npm](https://www.npmjs.com/package/dsh-mcp-admin) | MCP admin for dsh: /mcp server status and per-profile MCP server management (add/edit/delete/enable) from the settings page, via a typert remote. | 0.1.0-rc.6 (2026-08-14) |
| dsh-plugin-manager | 0 | [2768651338/dsh-plugin-manager](https://github.com/2768651338/dsh-plugin-manager) | 插件管家——图形化插件管理：中文名与用途说明目录 + 一键启停（写入全局 cordis.patch.yml，实时热生效） | 0.1.0-rc.6 (2026-08-14) |
| dsh-plugin-manager-monk233 | 0 | [monk233/dsh-plugin-manager](https://github.com/monk233/dsh-plugin-manager) · [npm](https://www.npmjs.com/package/@dsh-external/dsh-plugin-manager) | Manage dsh profile plugins from the web UI: enable / disable / delete composition rows with live hot reload, no config editing by hand | 0.1.0-rc.6 (2026-08-14) |
| dsh-store | 0 | [huguangyu666/dsh-store](https://github.com/huguangyu666/dsh-store) · [npm](https://www.npmjs.com/package/dsh-store) | DeepSeek Harness 插件商店：npm 权威源聚合（250+ 插件）+ dsh 字段质量验证 + GitHub 星标，一键安装/卸载（自动合并 cordis.patch.yml），重启生效。 | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-engineering-services | 0 | [wefio/dsh-engineering-services](https://github.com/wefio/dsh-engineering-services) | IDE engineering services for DeepSeek Harness: LSP diagnostics/navigation/rename, DAP debugging (debugpy + js-debug), and task-toolchain build/test/lint runs. | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-fun-ticker | 2 | [omdsh-dev/dsh-fun-ticker](https://github.com/omdsh-dev/dsh-fun-ticker) · [npm](https://www.npmjs.com/package/@deepseek-ai/dsh-fun-ticker) | Ticker tape: user-selected crypto/FX/A-share/index/HK/US quotes in a scrolling strip above the composer, proxied and cached host-side | 0.1.0-rc.6 (2026-08-14) |
...
| dsh-meme | 0 | [omdsh-dev/dsh-meme](https://github.com/omdsh-dev/dsh-meme) · [npm](https://www.npmjs.com/package/@dsh-external/dsh-meme) | 让 agent 在回复正文内联渲染表情包：inject_meme 工具 + systemPrompt 引导 + webServer 图片路由 | 0.1.0-rc.6 (2026-08-14) |
| dsh-multi-pet | 0 | [YiYan129600/dsh-multi-pet](https://github.com/YiYan129600/dsh-multi-pet) · [npm](https://www.npmjs.com/package/@linxin666/dsh-multi-pet) | Multi-pet compat for DSH Web: isolates the built-in pet service so it coexists with third-party pets (whale-girl). 多桌宠兼容：隔离内置桌宠服务，使其与第三方桌宠同时运行。 | 0.1.0-rc.6 (2026-08-14) |
| dsh-whale-arcade | 0 | [jitengfei/dsh-whale-arcade](https://github.com/jitengfei/dsh-whale-arcade) · [npm](https://www.npmjs.com/package/dsh-whale-arcade) | floating whale arcade for DeepSeek Harness with three browser-local games | 0.1.0-rc.6 (2026-08-14) |
...
| oh-my-dsh-amplift | 0 | [amplifthq/oh-my-dsh](https://github.com/amplifthq/oh-my-dsh) | Plugins, sensible defaults, and a launcher for DeepSeek Harness (dsh) — everything you're missing, without forking upstream. | 0.1.0-rc.6 (2026-08-14) |
